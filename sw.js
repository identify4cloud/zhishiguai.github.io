...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-d0d087","is-html-d0d087","is-jsdelivr-d0d087","is-gtm-d0d087","is-gravatar-d0d087","is-theme-d0d087","is-cdn-d0d087","is-json-d0d087"];
      return Promise.all(
        names
